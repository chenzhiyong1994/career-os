...
description: 将已经确认的简历内容制作成一页 A4 HTML/PDF，并完成模板复制、头像处理、导出和视觉 QA。用于纯排版、HTML/PDF 成品、打印优化和交付检查；不用于 JD 分析、事实判断、ATS 策略或简历措辞改写。
---
...
1. 确认输入已经稳定：正文、联系方式、日期、链接和头像均来自用户确认的信息。
2. 创建独立工作目录：
